...
X_train = np.load('./saved_models/mnist1d-classes37/time100_channels15_samples1000_layers3500_eps0.1_eta0.5/features/X_train_features.npy')
y_train = np.load('./saved_models/mnist1d-classes37/time100_channels15_samples1000_layers3500_eps0.1_eta0.5/features/X_train_labels.npy')
X_test = np.load('./saved_models/mnist1d-classes37/time100_channels15_samples1000_layers3500_eps0.1_eta0.5/features/X_test_features.npy')
y_test = np.load('./saved_models/mnist1d-classes37/time100_channels15_samples1000_layers3500_eps0.1_eta0.5/features/X_test_labels.npy')
