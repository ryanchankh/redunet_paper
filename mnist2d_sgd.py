...
X_train, y_train = F.filter_class(X_train, y_train, args.classes, args.samples*args.layers)  #NOTE: total training samples = number of layers * number of samples each layer
